<?
	...
	//Code already used ?
	$req = "SELECT code FROM lg_transactions WHERE code = '".$RECALL."' AND date_transaction + ".$days_31.' > '.$time;
	$t = mysql_query($req);
	if (mysql_num_rows($t)) exit;

	// $AUTH doit contenir l'identifiant de VOTRE document

	$AUTH = urlencode('176058/510025/346424');
...
<head>
	...
	<noscript>
		<meta http-equiv="Refresh" content="0;url=https://payment.allopass.com/error.apu?ids=176058&idd=510025">
	</noscript>
	<script language="Javascript" src="https://payment.allopass.com/api/secure.apu?ids=176058&idd=510025"></script>
