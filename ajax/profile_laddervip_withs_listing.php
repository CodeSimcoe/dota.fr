		...
		if ($year + $month + $day == 0) {
			$req = "
				...
				ORDER BY
				 ...
				 r.month DESC";
			echo '<br /><br />';
			echo createDatesTable($pwith.' - Listing Ladder VIP', $req, 'vip_withs', $pwith, 'M');
			...
			$req = "
				...
				ORDER BY
				 ...
				 r.day DESC";
			echo '<br /><br />';
			echo createDatesTable($pwith.' - '.date("F Y", $mon), $req, 'vip_withs', $pwith, 'D');
