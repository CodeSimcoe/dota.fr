...
require('/home/www/ligue/parser/w3g-julas-convert-v652e.php');
							...
							switch ($value{0}) {
								...
								case 'a':
									...
									&& $this->players[$player_id]['heroes'][$hero]['abilities'][$retraining_time][$ability] < 3) {
										...
										if ($hero != "Any") {
											if (!$this->players[$player_id]['dotaherodetected']) {
												$this->players[$player_id]['dotaherodetected'] = TRUE;
												$this->players[$player_id]['dotaheroname'] = $hero;
											}
											if ($this->time < 200000 && isset($this->players[$player_id]['dotaheroname']) && ($hero != $this->players[$player_id]['dotaheroname'])) {
												unset($this->players[$player_id]['heroes'][$this->players[$player_id]['dotaheroname']]);
												$this->players[$player_id]['dotaheroname'] = $hero;
											}
										}
									}
