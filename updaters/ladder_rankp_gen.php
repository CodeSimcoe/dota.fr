<?php
	...
	/*$out = 	'<?php ArghPanel::begin_tag();include \'campaigns/lol-goa.php\';ArghPanel::end_tag(); ?>';*/
	...
	$req = "SELECT u.username, c.tag, u.pts, count(f.player), c.id, u.country
			...
			ORDER BY u.pts DESC, count(f.player) DESC, u.username ASC
			LIMIT 100";
	...
	//Ecriture
	$filename = '/var/www/ligue/ladder_rankp.php';
